...
# eq = Equilibrium.load("/scratch/gpfs/rg6256/DESC_ball_tests/OT_ball_H100/eq00_finite_beta_and_iota.h5")
eq = Equilibrium.load("/scratch/gpfs/rg6256/DESC_ball_tests/OT_ball_H100/eq_final.h5")
...
# np.savez("./OT_ball_H100/gamma_max_OT_ball3_H100_hres_correct_norm_initial_new_022_wider_zeta1", alpha = alpha_arr, rho =np.array(surfaces), lambda_max = gamma_max)
np.savez(
    "./OT_ball_H100/gamma_max_OT_ball3_H100_hres_correct_norm_optimized_new_022_wider_zeta1",
    alpha=alpha_arr,
